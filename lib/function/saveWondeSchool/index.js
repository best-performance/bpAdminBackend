        ...
        batchToWrite.push({
          PutRequest: {
            Item: {
              ...
              __typename: "ClassroomYearLevel", // used hard coded as tableName may change with env
              createtAt: dayjs(),
              updatedAt: dayjs(),
            },
          },
        ...
        batchToWrite.push({
          PutRequest: {
            Item: {
              ...
              __typename: "ClassroomYearLearningArea", // used hard coded as tableName may change with env
              createtAt: dayjs(),
              updatedAt: dayjs(),
            },
          },
        ...
        batchToWrite.push({
          PutRequest: {
            Item: {
              ...
              dbType: "user",
              __typename: "User", // used hard coded as tableName may change with env
              createtAt: dayjs(),
              updatedAt: dayjs(),
            },
          },
        ...
        batchToWrite.push({
          PutRequest: {
            Item: {
              ...
              __typename: "SchoolStudent", // used hard coded as tableName may change with env
              createtAt: dayjs(),
              updatedAt: dayjs(),
            },
          },
            ...
            Item: {
              ...
              studentID:
                studentIDRecord && studentIDRecord.studentID
                  ...
                  : "missing",
              __typename: "ClassroomStudent", // used hard coded as tableName may change with env
              createtAt: dayjs(),
              updatedAt: dayjs(),
            },
          },
